    ...
    public partial class Inicio : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IIDBITACORASISTEMA = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IIDUSUARIO = table.Column<int>(nullable: false),
                    DESCRIPCIONBITACORA = table.Column<string>(unicode: false, maxLength: 200, nullable: true),
                    FECHAACTIVIDAD = table.Column<DateTime>(type: "datetime", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__BITACORA__CE5281B56D4E1264", x => x.IIDBITACORASISTEMA);
                    table.ForeignKey(
                        name: "FK__BITACORAS__IIDUS__7E37BEF6",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BITACORASISTEMA_IIDUSUARIO",
                table: "BITACORASISTEMA",
                column: "IIDUSUARIO");
