...
function callTable() {
    paintTable('/empleado/listEmpleado', ['nombre', 'edad', 'telefono', 'dui'],
            ...
            if (!isNaN($('#telefono').val())) {
                ...
                if (dui.length == 10) {
                    ...
                    if (contraseña1.length >= 5) {
                        ...
                        messeges('error', 'Las contraseña debe de tener por lo menos 5 caracteres');
                    }
                } else {
                ...
                messeges('error','El telefono solo acepta numeros')
            }//validacion telefono
        } else {
