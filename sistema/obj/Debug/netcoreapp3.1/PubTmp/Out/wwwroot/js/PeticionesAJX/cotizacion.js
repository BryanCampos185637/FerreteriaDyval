...
function callTable() {
    paintTable('/Cotizacion/listDetalleCotizacion', ['producto', 'cant', 'P.U', 'comi', 'p.com', 'desc', 'p.des', 'subt']);
};
/**
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data > 0) {
                    ...
                    messeges('error', 'Se ha superado el limite de cotizacion establecido en el sistema');
                } else {
                    messeges('error', 'Error al crear la cotizacion');
                }
            }
        })
    } else {
        ...
        if (result.isConfirmed) {
            $.get('/cotizacion/cancelarCotizacion', function (e) {
                if (e > 0) {
                    ...
                    document.getElementById('totalVenta').innerHTML = '$0.00';
                    callTable();
                    messeges('success', 'Cotizacion cancelada');
                    limpiar();
                } else {
